...
export default class Receipt {
  ...
  private readonly firstParagraph = [
    {
      texts: [
        'Recebi de ',
        this.receipt.tenant.name,
        ', inscrito no CPF ',
        formatCpf(this.receipt.tenant.cpf),
        ',',
      ],
      bolds: [1, 3],
    },
    {
      texts: [
        'o valor de ',
        formatCurrency(this.receipt.amount),
        ' (',
        porExtenso.format(this.receipt.amount),
        '),',
      ],
      bolds: [1, 3],
    },
    {
      texts: [
        ...
        formatDate(this.receipt.rentingPeriod, {
          month: 'long',
          year: 'numeric',
        }),
      ],
    ...
    },
    {
      texts: [
        ...
        this.receipt.house.street,
        ', ',
        this.receipt.house.number,
        '.',
      ],
      bolds: [1, 3],
    },
  ...
  private readonly lineHeight =
    this.doc.setFontSize(16).getTextDimensions('Uma linha').h + 1.5;
  ...
  private readonly title = {
    ...
    y:
      this.page.m +
      this.mainBox.mt / 2 +
      this.doc.setFontSize(19).getTextDimensions(this.titleText).h * 0.3,
  ...
  private readonly body = {
    ...
    h:
      this.lineHeight *
      (this.firstParagraph.length + this.secondParagraph.length + 1.5),
    mx: 4,
    my: 10,
  ...
  private readonly numberBox = {
    x:
      ...
      this.page.m -
      this.mainBox.mx -
      this.doc.getTextDimensions('Nº 0000').w,
  ...
  constructor(
    public receipt: ReceiptSchema,
    public pastPaidDebitsCount: number = 1
  ) {}

  public makePdf() {
    const pdfNumber = (this.pastPaidDebitsCount + 1)
      .toString()
      .padStart(4, '0');
    this.doc
      .setFillColor(...this.mainBox.bgColor)
      .roundedRect(
        this.mainBox.x,
        this.mainBox.y,
        this.mainBox.w,
        this.mainBox.h,
        this.mainBox.rounded,
        this.mainBox.rounded,
        'F'
      )
      .setFont('Times', 'bold')
    ...
    this.writeParagraph(
      ...
      this.body.x + this.body.mx,
      this.body.y + this.body.my + this.lineHeight * 4 + 4
    );
    this.writeParagraph(
      this.footerParagraph,
      this.body.x + this.body.mx,
      this.footer.y + this.footer.my
    );
    return this.doc;
  }
